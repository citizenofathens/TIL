...
재귀함수는 맨 마지막에 호출 되는 함수에서 실행되면서 올라온다 . 함수 호출은



# 병합 정렬 c언어 코드 
#https://gmlwjd9405.github.io/2018/05/08/algorithm-merge-sort.html
# 병합 정렬 실제 구현 과정 가장 왼쪽 부터 분할 해서 정복해 나가기 때문에 left<right가 참이면 계속 해서 호출한다 
#https://ratsgo.github.io/data%20structure&algorithm/2017/10/03/mergesort/ <- 근데 시간 초과 뜬다고 함

개념 가지고 생각해보면 나눌 수 있을 때까지 나누고 정렬은 병합할 때 이루어진다는것을 기억


# c언어  /  연산자 .. 몫 만 들어간다고 반올림이 아니라 그리고 함수 호출했을 때 내부 과정 모두 처리해서 리턴 하는 것 이것과 인덱스 이런 기초개념만 탄탄했어도 금방 이해했을것
